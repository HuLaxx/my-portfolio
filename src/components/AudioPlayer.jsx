    ...
    return (
        <div className="fixed bottom-6 left-8 z-50 flex items-center">
            ...
            <motion.button
                ...
                animate={{ width: isPlaying ? "auto" : "2.5rem" }}
                transition={{ type: "spring", stiffness: 500, damping: 30 }}
                className={`relative h-10 rounded-full backdrop-blur-2xl border overflow-hidden flex items-center group z-20 ${getActiveStyle()}`}
            >
                {/* Shine Effect */}
                {isPlaying && (
                    <motion.div
