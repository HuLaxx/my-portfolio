...
export const MobileMenu = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Menu Panel */}
            <div
                className="fixed top-0 right-0 h-full w-[75%] max-w-[280px] bg-[var(--panel)] border-l border-[var(--border)] z-50 md:hidden transform transition-transform duration-300 ease-out flex flex-col"
                role="dialog"
                aria-modal="true"
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute top-6 right-6 h-10 w-10 flex items-center justify-center rounded-full border border-[var(--border)] bg-[var(--card)] hover:bg-[var(--accent)] hover:border-[var(--accent)] transition-all duration-300 z-50"
                ...
                {/* Navigation Links */}
                <nav className="flex flex-col gap-1 px-8 pt-24 pb-8 flex-1">
                    {navLinks.map((link, index) => (
                        <Link
                            key={link.href}
                            href={link.href}
                            onClick={onClose}
                            className="group relative block py-4 text-2xl font-semibold tracking-tight text-white transition-all duration-300 hover:translate-x-2 border-b border-white/5"
                ...
                {/* Social Icons */}
                <div className="px-8 pb-6 flex gap-4 justify-center">
                ...
                <div className="px-8 pb-8">
                    <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gray-600 text-center">
